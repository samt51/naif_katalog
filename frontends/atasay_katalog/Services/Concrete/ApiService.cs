...
namespace atasay_katalog.Services.Concrete
{
    public class ApiService : IApiService
    {
        ...
        {
            // This browser frontend uses only its own token cookie. Match the
            // customer cache scope; do not accept alternate request identities.
            var token = _httpContextAccessor.HttpContext?.Request.Cookies["Atasay.ApiToken"];
