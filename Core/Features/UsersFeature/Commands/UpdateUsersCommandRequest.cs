...
{
    public class UpdateUsersCommandRequest : IRequest<ResponseDto<UpdateUsersCommandResponse>>
    {
        ...
        public string? Password { get; set; } // Update is missing Password in API side, but we should send it if changed
